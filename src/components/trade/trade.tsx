    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-5">
        <div className="w-full mx-auto px-6 py-8">
          ...
          {/* Main Trading Area */}
          <div
            className="border rounded-lg border-primary/30 grid grid-cols-1 lg:grid-cols-4 gap-6 animate-slideUp"
            style={{ animationDelay: "0.1s" }}
          >
            {/* Left Panel - Trading Controls */}
            <div className="border lg:col-span-1">
              <Card className=" p-6 border-border/50 backdrop-blur-sm sticky top-24 space-y-4">
            ...
            <div className="border lg:col-span-2">
              <Card className=" p-6 border-border/50 backdrop-blur-sm h-full min-h-[600px] flex flex-col">
            ...
            <div className="lg:col-span-1">
              <Card className="p-6 border-border/50 backdrop-blur-sm h-full">
            ...
            <Card className="border-border/50 backdrop-blur-sm">
              <Tabs defaultValue="history" className=" w-full">
                <TabsList className="w-full justify-start rounded-none border-b border-border/30 px-6 py-0 h-auto bg-transparent">
                  <TabsTrigger
                    value="history"
                    className="rounded-sm border-b-2 border-transparent data-[state=active]:border-primary"
                  >
                    Trade History
                  </TabsTrigger>
                  <TabsTrigger
